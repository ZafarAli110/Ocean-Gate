...
// http://javascript-source.com
//***********************************************
jQuery("#wowslider-container1").wowSlider({effect:"blinds",prev:"",next:"",duration:36*100,delay:20*100,width:996,height:360,autoPlay:true,autoPlayVideo:false,playPause:false,stopOnHover:true,loop:false,bullets:1,caption:true,captionEffect:"parallax",controls:true,controlsThumb:false,responsive:1,fullScreen:false,gestures:2,onBeforeStep:0,images:[{src:"./images_1.jpg",title:"OCEAN GATE"},{src:"./images.jpg",title:"OCEAN GATE"},{src:"./sd_1.jpg",title:"OCEAN GATE"},{src:"./sony_usb_1.jpg",title:"OCEAN GATE"},{src:"./sony_usb_2.jpg",title:"OCEAN GATE"},{src:"./usb_1.jpg",title:"OCEAN GATE",href:"http://wowslider.net"},{src:"./usb_2.jpg",title:"OCEAN GATE"}]});